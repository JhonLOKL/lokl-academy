...
export function LocationIndie() {
  const locationImages = [
    {
      src: 'https://lokl-assets.s3.us-east-1.amazonaws.com/indie-universe/img-hotel-full-entry.png',
      alt: 'Entrada principal del hotel Indie Universe',
    },
    {
      src: 'https://lokl-assets.s3.us-east-1.amazonaws.com/indie-universe/img-front-principal-entry.png',
      alt: 'Fachada principal de Indie Universe',
    },
    {
      src: 'https://lokl-assets.s3.us-east-1.amazonaws.com/indie-universe/img-hotel-creativo-indie.jpg',
      alt: 'Hotel creativo Indie Universe',
    },
  ];
    ...
    <section className="w-full">
      ...
      <div className="flex items-center w-full justify-center mt-4 gap-2">
        ...
        <a
          ...
          href="https://maps.app.goo.gl/B7JQiZpwG9AWpYWZA"
          target="_blank"
          rel="noreferrer"
        >
          Ubicación de Indie Universe
        </a>
      </div>
    </section>
  );
