...
const INVESTOR_PROFILE_CONFIG: InvestorProfileConfig[] = [
  {
    ...
    multiplier: 100,
    benefits: [
      "Descuento 10% en espacios operados por Nido de Agua",
  ...
  },
  {
    ...
    multiplier: 200,
    benefits: [
      "Descuento 20% en espacios operados por Nido de Agua",
      "Participa de la lotería de noches y experiencias de Nido",
  ...
  },
  {
    ...
    multiplier: 500,
    benefits: [
      "Descuento 25% en espacios operados por Nido de Agua",
      "Participa de la lotería de experiencias de Nido y 1 Noche Gratis al año",
      "Acceso a asesorías privadas para evaluar portafolio",
    ],
  },
];
